...
1. Download **Mukti-Setup-2.0.3.exe** from [GitHub Releases](https://github.com/GRU-953/Mukti/releases)
...
1. Download **Mukti-2.0.3.pkg** from [GitHub Releases](https://github.com/GRU-953/Mukti/releases)
